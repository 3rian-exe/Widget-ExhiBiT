...
// where to start looking if things go bad.

using namespace std; 
// Basic text printing function using the setpixel function.
...
// Custom library for drawing text to the display for Widget Exhibit
                                                        ...
                                                        int r, int g, int b)
{
    switch (letter)
    {
        ...
        case '0':
        {
            ...
            canvas -> SetPixel(xOrigin + 2, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 4, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 5, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 6, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 7, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 8, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 14, r, g, b);
        ...
        case '1':
        {
            ...
            canvas -> SetPixel(xOrigin + 4, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 9, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 4, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 14, r, g, b);
        ...
        case '2':
        {
            ...
            canvas -> SetPixel(xOrigin + 7, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 12, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 13, r, g, b);
            ...
            canvas -> SetPixel(xOrigin + 7, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 13, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 14, r, g, b);
            ...
            canvas -> SetPixel(xOrigin + 7, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 14, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 14, r, g, b);            
        ...
        case '4':
        {
            ...
            canvas -> SetPixel(xOrigin + 4, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 10, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 11, r, g, b);
            ...
            canvas -> SetPixel(xOrigin + 4, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 5, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 6, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 7, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 8, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 11, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 11, r, g, b);        
            canvas -> SetPixel(xOrigin + 6, yOrigin + 12, r, g, b);
        ...
        case '5':
        {
            ...
            canvas -> SetPixel(xOrigin + 8, yOrigin + 0, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 0, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 0, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 0, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 1, r, g, b);
            ...
            canvas -> SetPixel(xOrigin + 8, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 1, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 3, yOrigin + 2, r, g, b);
            ...
            canvas -> SetPixel(xOrigin + 8, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 9, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 10, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 11, yOrigin + 2, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 1, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 2, yOrigin + 3, r, g, b);
            canvas -> SetPixel(xOrigin + 0, yOrigin + 4, r, g, b);
